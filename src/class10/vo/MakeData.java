...
public class MakeData {
	...
	public Professor[] proArr = new Professor[6];
	...
	public MakeData() {
		...
		proArr[1] = new Professor("92002", "690702-1350026", "고희석", 923, "교수", "2003");
		proArr[2] = new Professor("92301", "741011-2765501", "최성희", 920, "부교수", "2005");
		proArr[3] = new Professor("92302", "750728-1102458", "김태석", 923, "부교수", "1999");
		proArr[4] = new Professor("92501", "620505-1200546", "박철재", 925, "교수", "2007");
		proArr[5] = new Professor("92502", "740101-1830264", "장민석", 920, "조교수", "2005");
	}
